...
Варинаты решения: input.split(' ') - слева остаётся синтаксис функции, справа название + параметры: signature = "def is_e_in_L(e, L)".split(' ', maxsplit = 1) -> ['def', 'is_e_il_L(e, L)]
